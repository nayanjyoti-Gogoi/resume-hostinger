            ...
            <Col lg={4} md={6} className="mb-4">
              <Card className="template-card">
                ...
                <Card.Body>
                  ...
                  <Button as={Link} to="/builder?template=modern-teal" variant="primary">Use This Template</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col lg={4} md={6} className="mb-4">
              <Card className="template-card">
                <Card.Img variant="top" src="" />
                <Card.Body>
                  <Card.Title>Blue Sidebar</Card.Title>
                  <Card.Text>
                    Creative template for designers, artists, and creative professionals.
                  </Card.Text>
                  <Button as={Link} to="/builder?template=blue-sidebar" variant="primary">Use This Template</Button>
                </Card.Body>
              </Card>
            </Col>
          </Row>
